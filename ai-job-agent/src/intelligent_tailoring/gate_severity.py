...
CRITICAL_PREFIXES: tuple[str, ...] = (
    ...
    "empty_experience_entries",
    "empty_project_entries",
    "experience_shown_without_bullets",
    "project_shown_without_content",
    "duplicate_title_phrase_in_summary",
    "react_categorized_as_backend",
    "high_relevance_facts_silently_omitted",
    "skills_severely_underfilled",
    "generic_other_skill",
    "raw_llm_reasoning",
