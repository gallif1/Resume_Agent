...
# Standalone /cv-tailor MVP must stay fast for mobile (gpt-5 often takes 60–90s and
# mobile browsers drop the session). Override with OPENAI_CV_TAILOR_MODEL if needed.
OPENAI_CV_TAILOR_MODEL = os.getenv("OPENAI_CV_TAILOR_MODEL", "").strip() or "gpt-4o-mini"
